...
We can see there are some potential non-linear relationships, for instance: the ideology variable. The next step is to consider adding an exponent the ideology variable. __Note:__ We want to avoid over fitting our model to the sample data. Therefore its important to have an understanding of why you are including an exponent.
