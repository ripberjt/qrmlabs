...
This lab focuses on addressing issues that arise with non-linearity, non-normality, and multicollinearity. We begin by addressing non-linearity. The following packages are required for this lab: 
...
Start by looking at a scatter plot. To assistWe'll need to jitter the data because ideology is a discrete variable:
