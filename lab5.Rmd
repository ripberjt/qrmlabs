...
Now that we have our data frame, let's create a new visualiazation that includues the confidence intervals. To do this, we make the same visualization from earlier, but include a geom_errorbar() function. Inside the function we tell R to use the lower and upper confidence interval values:
