...
Similar to `filter()`, you can use the `select()` function to create a new data set that includes a few variables of interest. Follow it up by using `na.omit()` to remove missing observations:
