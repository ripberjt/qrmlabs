...
\includegraphics{lab3_files/figure-latex/hist1-1.pdf}
...
\includegraphics{lab3_files/figure-latex/hist2-1.pdf}
...
\includegraphics{lab3_files/figure-latex/hist3-1.pdf}
...
\includegraphics{lab3_files/figure-latex/hist5-1.pdf}
...
\includegraphics{lab3_files/figure-latex/norm-1.pdf}
...
\includegraphics{lab3_files/figure-latex/norm2-1.pdf}
...
\includegraphics{lab3_files/figure-latex/norm3-1.pdf}
...
\includegraphics{lab3_files/figure-latex/rnorm-1.pdf}
...
\includegraphics{lab3_files/figure-latex/three2-1.pdf}
...
\includegraphics{lab3_files/figure-latex/three4-1.pdf}
...
\includegraphics{lab3_files/figure-latex/three5-1.pdf}
...
\includegraphics{lab3_files/figure-latex/three6-1.pdf}
...
\includegraphics{lab3_files/figure-latex/three7-1.pdf}
...
\includegraphics{lab3_files/figure-latex/three8-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ds}\OperatorTok{$}\NormalTok{z.age <-}\StringTok{ }\KeywordTok{scale}\NormalTok{(ds}\OperatorTok{$}\NormalTok{age)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ds[}\KeywordTok{which}\NormalTok{(ds}\OperatorTok{$}\NormalTok{f.gender}\OperatorTok{==}\StringTok{'Women'} \OperatorTok{&}\StringTok{ }\NormalTok{ds}\OperatorTok{$}\NormalTok{age }\OperatorTok{<}\StringTok{ }\DecValTok{19}\NormalTok{), }\KeywordTok{c}\NormalTok{(}\StringTok{"f.gender"}\NormalTok{, }\StringTok{"age"}\NormalTok{, }\StringTok{"z.age"}\NormalTok{)]}
\end{Highlighting}
\end{Shaded}
