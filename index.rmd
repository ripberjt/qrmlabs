...
Each chapter is written in R Markdown, allowing readers to follow along and interact with examples via their favorite integrated development environment, "IDE," (e.g., RStudio), or to knit as a PDF. For more information on R Markdown, visit: https://rmarkdown.rstudio.com/.
