...
This lab will focus on the ways in which we can use and understand categorical independent variables. So far the independent variables we have worked with have mainly been interval or ordinal data. When working with categorical data, there are different approaches and techniques of interpretation. 

## Part One: Dummy Variables
...
## Part Three: Releveling Variables
