...
Notice how the bottom right quadrant of RStudio now shows you information about the mean function. Similarly, you can also type the function name into the help search bar. 
...
If you keep running into a problem, a quick Google search can often get you a solution. Websites like StackExchange have loads of helpful answers to common problems in R. At times it might feel like you're the only person to have a particular problem, but someone else has almost certainly had the same problem, and the solution likely can be found online.
...
There are two ways to set your working directory. The first way is to include the code
