...
if("HistData" %in% rownames(installed.packages()) == FALSE){install.packages("HistData")}
library(car)
library(psych)
library(sm)
library(HistData)
...
There are many different ways to test for normality, one of which is to visualize the data using a particular visualization. In the last lab we went over density plots, box plots, and QQplots. Let's visualize our new data using a QQplot. Remember that a QQ plot graphs the quantiles of your data against the qunaitiles of what normally-distributed data should be given the mean and standard deviation of the data. 
